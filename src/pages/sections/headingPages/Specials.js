...
import GreekSalad from "./../../../assets/food_menu/greek-salad.webp";
import Bruschetta from "./../../../assets/food_menu/bruschetta.jpeg";
import LemonDessert from "./../../../assets/food_menu/lemon-dessert.webp";
  ...
  return (
    <section className="specials">
      <article className="specials-topbar">
        ...
        <a className="action-button" href={require("../../../assets/icons/menu.webp")} target="_blank" rel="noreferrer">
          Online Menu
        </a>
      </article>
